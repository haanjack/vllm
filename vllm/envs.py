...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_USE_FLA_TUNING: bool = True
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to use AMD-optimized auto-tuning for Flash-Linear-Attention (FLA).
    # Enables architecture-specific tuning parameters for CDNA3/CDNA4 GPUs.
    # By default is enabled on AMD GPUs.
    "VLLM_ROCM_USE_FLA_TUNING": lambda: (
        os.getenv("VLLM_ROCM_USE_FLA_TUNING", "True").lower() in ("true", "1")
    ),
