...
"""Inference-only Param2MoE model compatible with HuggingFace weights."""
...
class Param2Attention(nn.Module):
    def __init__(
        self,
...
class Param2MoeBlock(nn.Module):
    def __init__(
        ...
        self.attention = Param2Attention(
...
class Param2MoEForCausalLM(nn.Module, SupportsPP, SupportsLoRA):
